...
class HouseAnimatedWidget extends StatefulWidget {
  ...
  const HouseAnimatedWidget(
      {super.key, required this.animationController, this.scrollEvent});

  @override
  State<HouseAnimatedWidget> createState() => _HouseAnimatedWidgetState();
}

class _HouseAnimatedWidgetState extends State<HouseAnimatedWidget>
  ...
  void initState() {
    ...
    buttonAnimation =
        Tween<double>(begin: 0, end: 2212).animate(buttonAnimationController);

    slideInAnimationController = widget.animationController;
    slideInAnimation =
        Tween<double>(begin: 0, end: 7).animate(slideInAnimationController)
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
        ...
        builder: (builder, _) {
          return slideInAnimation.value == 0
              ? SizedBox.shrink()
              : Container(
                  ...
                  child: StaggeredGrid.count(
                      ...
                      mainAxisSpacing: 4,
                      crossAxisSpacing: 4,
                      children: GetHouseUseCase.houses()
                          .map((house) => StaggeredGridTile.count(
